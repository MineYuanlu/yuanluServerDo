...
public final class TransHandler {
	 ...
	 * @param home   家信息
	 */
	public static synchronized void receiveHome(Player player, TransHome home) {
		if (home == null) {
	 ...
	 * @param warp   地标信息
	 */
	public static synchronized void receiveWarp(Player player, TransWarp warp) {
		if (warp == null) {
